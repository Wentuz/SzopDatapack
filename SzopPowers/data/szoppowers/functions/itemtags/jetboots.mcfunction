...
execute at @a[nbt={Inventory:[{Slot:100b,tag:{jet:1}}]},scores={sneaks=1..}] run scoreboard players set @a[nbt={Inventory:[{Slot:100b,tag:{jet:1}}]},scores={sneaks=1..}] sneaks 0
